    ...
    def __init__(self, **kwargs):
        ...
        michigan_updates = {
            "logo": {
                ...
                "path": "https://raw.githubusercontent.com/rajraomichigan/hockey_rink/master/images/michigan_hockey.png",
        ...
        for k, v in michigan_updates.items():
...
class NWHLRink(NHLRink):
    ...
    def __init__(self, **kwargs):
        ...
        nwhl_updates = {
            ...
            "logo": {
                "class": rf.CircularImage,
                "path": "https://raw.githubusercontent.com/rajraomichigan/hockey_rink/master/images/nwhl_logo.png",
                "radius": center_radius,
                "is_constrained": False,
                "zorder": 11
            }
